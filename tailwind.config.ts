    ...
    extend: {
      ...
      keyframes: {
        pulseLeftToRight: {
          ...
          '40%': { transform: 'scaleX(1)', transformOrigin: 'left', opacity: "1" },
          '40.1%': { transform: 'scaleX(1)', transformOrigin: 'right', opacity: "1" },
          '80%': { transform: 'scaleX(0)', transformOrigin: 'right', opacity: "0.8" },
          '100%': { transform: 'scaleX(0)', transformOrigin: 'right', opacity: "0.8" },
        },
        pulseRightToLeft: {
          '0%': { transform: 'scaleX(0)', transformOrigin: 'right', opacity: "0.8" },
          '40%': { transform: 'scaleX(1)', transformOrigin: 'right', opacity: "1" },
          '40.1%': { transform: 'scaleX(1)', transformOrigin: 'left', opacity: "1" },
          '80%': { transform: 'scaleX(0)', transformOrigin: 'left', opacity: "0.8" },
          '100%': { transform: 'scaleX(0)', transformOrigin: 'left', opacity: "0.8" },
        },        
        heartbeat: {
