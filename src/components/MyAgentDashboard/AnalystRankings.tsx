...
const AnalystRankings: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      <UserDataProvider>
        <main className="flex-grow py-6 max-w-7xl mx-auto w-full">
          <div className="mb-6 text-center mt-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">
              <span className="font-napzerRounded bg-gradient-to-r from-[#AAC9FA] via-[#E1EAF9] to-[#AAC9FA] bg-clip-text text-transparent">
                Analyst Rankings
              </span>
            </h2>
...
export default React.memo(AnalystRankings);
