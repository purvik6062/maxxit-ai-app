...
const Trading = ({
  ...
  const [liveTransaction, setLiveTransaction] = useState<any>([]);
  ...
  useEffect(() => {
    ...
    const user = localStorage.getItem("USER_MEMBERSHIP") || "notMember";
                ...
                <div className="pricing__tab active">
                  ...
                  {liveTransaction == null ? (
                    ...
                    <div className="pricing__conetnt">
                      ...
                      {liveTransaction?.map((transaction: any, index: any) => (
