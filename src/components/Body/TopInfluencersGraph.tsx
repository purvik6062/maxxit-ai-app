...
const InfluencerDetails: React.FC<InfluencerDetailsProps> = ({
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-4xl bg-gray-800/70 backdrop-blur-md p-4 rounded-xl shadow-xl my-4 sm:my-8 z-20 border border-cyan-500/30 flex flex-col sm:flex-row items-center justify-between"
    >
      {influencer ? (
        <div className="flex flex-col sm:flex-row items-center w-full space-y-4 sm:space-y-0 sm:space-x-6">
          <motion.div
        ...
        <p className="text-gray-400 text-center text-base sm:text-lg w-full">
