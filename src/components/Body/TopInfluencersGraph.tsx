...
const InfluencerDetails: React.FC<InfluencerDetailsProps> = ({ influencer }) => {
  return (
    <div className="relative w-full max-w-4xl my-8 z-20 bg-transparent">
      ...
      <motion.div
        ...
        className="relative w-full bg-gray-800/70 backdrop-blur-md p-6 rounded-xl shadow-xl z-20 border border-cyan-500/30 flex items-center justify-between overflow-hidden"
      >
        
        {influencer ? (
          <div className="flex items-center w-full space-x-6 z-20">
            <motion.div
            ...
            >
              ...
              <div className="relative">
                <img
                  ...
                  alt={influencer.name}
                  className="w-20 h-20 rounded-full object-cover shadow-lg z-20"
                />
            ...
            <div className="flex-1 flex items-center justify-between">
              ...
              <div className="flex space-x-4">
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-lg overflow-hidden group transition-all duration-300 hover:scale-105">
                  {/* Ember particle effect on hover */}
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100">
                  </div>
                  <div className="relative z-10">
                    <p className="text-xs text-gray-100">Signals (past 7d)</p>
                    <p className="text-base font-semibold text-cyan-400 animate-value-pulse">
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-lg overflow-hidden group transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <p className="text-xs text-gray-100">Tokens (past 7d)</p>
                    <p className="text-base font-semibold text-cyan-400 animate-value-pulse">
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 p-4 rounded-lg overflow-hidden group transition-all duration-300 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <p className="text-xs text-gray-100">Followers</p>
                    <p className="text-base font-semibold text-cyan-400 animate-value-pulse">
          ...
          <div className="w-full flex flex-col items-center justify-center py-8 z-20">
            <p className="text-cyan-300 text-center text-lg w-full font-medium">
              Select an influencer to view details
            </p>
            <p className="text-cyan-500/70 text-center text-sm mt-2">
