  ...
  return (
    <>
      ...
      {isCustomizationModalOpen && (
        ...
        //               </div>
        //               <p className="text-sm text-gray-400 mb-3">Emphasizes price action and volume. Perfect for trending markets and breakouts.</p>
        //               <div className="flex items-center text-xs text-gray-500">
        //                 <span>Price: 40% • Volume: 35% • AltRank: 20%</span>
        //               </div>
        //             </button>
        ...
        //               </div>
        //               <p className="text-sm text-gray-400 mb-3">Maximizes social signals and viral indicators. Ideal for catching meme coin runs.</p>
        //               <div className="flex items-center text-xs text-gray-500">
        //                 <span>Social: 40% • Sentiment: 25% • Influencers: 25%</span>
        //               </div>
        //             </button>
        ...
        //               </div>
        //               <p className="text-sm text-gray-400 mb-3">Conservative approach with quality filters. Reduces false signals in volatile markets.</p>
        //               <div className="flex items-center text-xs text-gray-500">
        //                 <span>Volume: 25% • Galaxy: 3pts • AltRank: 20%</span>
        //               </div>
        //             </button>
        //           </div>
        ...
        //                 <span>Negative thresholds signal bearish conditions</span>
        //               </li>
        //             </ul>
        //           </div>
        //         </div>
