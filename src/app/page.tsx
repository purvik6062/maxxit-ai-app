...
const HomePage: React.FC = () => {
  ...
  const handleInfluencerAdded = useCallback(async () => {
    ...
    try {
      ...
      setTimeout(async () => {
        try {
          const impactRetry = typeof impactRefreshData === "function" ? impactRefreshData() : Promise.resolve();
          const heartbeatRetry = typeof heartbeatRefreshData === "function" ? heartbeatRefreshData() : Promise.resolve();
